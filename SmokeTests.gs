...
function runRegressionTestSuiteFull_(options) {
  ...
  _smokePush_(report, "javascript runtime is modular", function () {
    ...
    _smokeAssert_(
      rawJavaScript.indexOf("Js.Render.Panel") !== -1,
      "JavaScript.html має підключати Js.Render.Panel (Phase 3 split)",
    );
    _smokeAssert_(
      rawJavaScript.indexOf("Js.Render.Calendar") !== -1 &&
        rawJavaScript.indexOf("Js.Render.Results") !== -1,
      "JavaScript.html має підключати Js.Render.Calendar та Js.Render.Results",
    );
    _smokeAssert_(
      runtime.indexOf("<script") !== -1,
      "includeTemplate(\'JavaScript\') не повернув script block",

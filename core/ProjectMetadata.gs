...
const PROJECT_STAGE7_ACCESS_API_ROLE_POLICY_ = Object.freeze({
  ...
  apiStage7MaterializeAllMonthJournals: Object.freeze({
    guestAllowed: false,
    minRole: "maintainer",
  }),
  apiStage7SetupTemporaryPropertyRegister: Object.freeze({
    guestAllowed: false,
    minRole: "admin",
  }),
  apiStage7RefreshTemporaryPropertyRegister: Object.freeze({
    guestAllowed: false,
    minRole: "maintainer",
  }),
  ...
  apiStage7ResumeBrowserSession: Object.freeze({
    guestAllowed: true,
  }),
...
const PROJECT_STAGE7_CLIENT_ROUTING_POLICY_ = Object.freeze({
  ...
  materializeAllMonthJournals: "apiStage7MaterializeAllMonthJournals",
  setupTemporaryPropertyRegister: "apiStage7SetupTemporaryPropertyRegister",
  refreshTemporaryPropertyRegister: "apiStage7RefreshTemporaryPropertyRegister",

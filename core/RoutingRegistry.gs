...
var WASB_STAGE7_ROUTING_REGISTRY_STORE_ =
  ...
  Object.freeze({
    sidebar: Object.freeze({
      ...
      getInventoryReconciliation: Object.freeze({
        routeName: "sidebar.getInventoryReconciliation",
        publicApiMethod: "apiStage7GetInventoryReconciliation",
        ...
        dryRunSupported: false,
        uiAllowed: true,
        clientActionAliases: ["inventoryReconciliation"],
        verifyAfterWrite: false,
      }),

      syncInventoryReconciliation: Object.freeze({
        routeName: "sidebar.syncInventoryReconciliation",
        publicApiMethod: "apiStage7SyncInventoryReconciliation",
        ...
        dryRunSupported: false,
        uiAllowed: true,
        clientActionAliases: ["inventoryReconciliationSync"],
        verifyAfterWrite: true,
      }),

      setInventoryReconciliationFolder: Object.freeze({
        routeName: "sidebar.setInventoryReconciliationFolder",
        publicApiMethod: "apiStage7SetInventoryReconciliationFolder",
      ...
      getSelectedInventoryReconciliation: Object.freeze({
        routeName: "sidebar.getSelectedInventoryReconciliation",
        publicApiMethod: "apiStage7GetSelectedInventoryReconciliation",
    ...
    maintenance: Object.freeze({
      ...
      materializeMonthJournal: Object.freeze({
        routeName: "maintenance.materializeMonthJournal",
        publicApiMethod: "apiStage7MaterializeMonthJournal",
        useCase: "materializeMonthJournalBundle_",
        category: "maintenance",
        compatibilityStatus: "canonical",
        mode: "write",
        lockRequired: true,
        dryRunSupported: false,
        uiAllowed: true,
        clientActionAliases: ["materializeMonthJournal"],
        verifyAfterWrite: false,
      }),
      ...
      runAllProjectTests: Object.freeze({
        routeName: "maintenance.runAllProjectTests",
        publicApiMethod: "apiRunStage7AllProjectTests",
        useCase: "Stage7TestRunner.runAllProjectTests",
        category: "maintenance",
        compatibilityStatus: "canonical",
        mode: "read",
        lockRequired: true,
        dryRunSupported: true,
        uiAllowed: true,
        clientActionAliases: ["runAllProjectTests"],
        verifyAfterWrite: false,
      }),
      ...
      getExternalSpreadsheetMigrationStatus: Object.freeze({
        routeName: "maintenance.getExternalSpreadsheetMigrationStatus",
        publicApiMethod: "apiGetExternalSpreadsheetMigrationStatus",
        ...
        dryRunSupported: true,
        uiAllowed: true,
        clientActionAliases: ["externalMigration"],
        verifyAfterWrite: false,
      }),

      getExternalStorageMode: Object.freeze({
        routeName: "maintenance.getExternalStorageMode",
        publicApiMethod: "apiGetExternalStorageMode",
      ...
      beginExternalSpreadsheetMigration: Object.freeze({
        routeName: "maintenance.beginExternalSpreadsheetMigration",
        publicApiMethod: "apiBeginExternalSpreadsheetMigration",
      ...
      previewExternalSpreadsheetMigration: Object.freeze({
        routeName: "maintenance.previewExternalSpreadsheetMigration",
        publicApiMethod: "apiPreviewExternalSpreadsheetMigration",
      ...
      applyExternalSpreadsheetMigration: Object.freeze({
        routeName: "maintenance.applyExternalSpreadsheetMigration",
        publicApiMethod: "apiApplyExternalSpreadsheetMigration",
      ...
      finalizeExternalSpreadsheetMigration: Object.freeze({
        routeName: "maintenance.finalizeExternalSpreadsheetMigration",
        publicApiMethod: "apiFinalizeExternalSpreadsheetMigration",
...
function listRoutingRoutes_() {
  ...
  Object.keys(groups).forEach(function (group) {
    Object.keys(groups[group] || {}).forEach(function (key) {
      out.push(
        Object.assign({ group: group, action: key }, groups[group][key] || {}),
      );
    });
  });
  return out;
...
function getRoutingRouteByName_(routeName) {
  ...
  return (
    listRoutingRoutes_().find(function (item) {
...
function getRouteCoverageReport_() {
  ...
  return {
    ...
    lockCoverage: critical.filter(function (item) {
      return item.lockRequired;
    }).length,
    dryRunCoverage: critical.filter(function (item) {
      return item.dryRunSupported;
    }).length,
    uiAllowedRoutes: routes.filter(function (item) {
      return item.uiAllowed;
    }).length,
    missingLockCoverage: critical

...
function _diagBuildStage7CoreChecks_(options) {
  ...
  _stage7PushCheck_(checks, 'Release naming aligned', release && release.archiveBaseName === 'gas_wasb_stage7_1_5_maintenance' && release.rootFolderName === 'gas_wasb_stage7_1_5_maintenance' ? 'OK' : 'FAIL', (release && release.archiveBaseName || 'n/a') + ' / ' + (release && release.rootFolderName || 'n/a'), 'Вирівняйте archive/root naming');

...
The current repository was **mostly flat before PR #34**; maintainers may move files into domain folders per [ADR-002](../adr/002-domain-folder-map.md) and [ADR-003](../adr/003-working-domain-layout.md).
